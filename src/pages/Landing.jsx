    ...
    <div className="page">
      ...
      <header className="nav">
        ...
        <nav className={menuOpen ? 'links open' : 'links'}>
          ...
          <Link to="/app" onClick={closeMenu}>Comunidade</Link>
          {user ? (
            <Link to="/app" onClick={closeMenu}>Entrar</Link>
          ) : (
      ...
      <section className="hero" id="topo">
        ...
        <div className="hero-actions">
          <Link className="btn gold" to="/entrar">Entrar na comunidade</Link>
      ...
      <section className="panel" id="comunidade">
        <div className="wrap narrow">
          <p className="kicker">Casa interna</p>
          <h2>Estudo, oração e prática</h2>
          <p className="intro">
            A parte pública explica o caminho. A comunidade — grupos de
            estudo, oração, sidur e exemplos — abre com o mesmo login
            Google do Hipercube.
          </p>
          <Link className="btn gold" to="/entrar">Entrar com Google</Link>
        </div>
      </section>
